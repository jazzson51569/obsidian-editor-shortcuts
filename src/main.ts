...
export default class CodeEditorShortcuts extends Plugin {
  ...
  async onload() {
    ...
    this.addCommand({
      ...
      editorCallback: (editor) =>
        withMultipleSelectionsNew(editor, moveLineUp),
    });
    ...
    this.addCommand({
      ...
      editorCallback: (editor) =>
        withMultipleSelectionsNew(editor, moveLineDown),
    });

    this.addCommand({
      id: 'moveCursorToFirstLine',
      ...
      editorCallback: (editor) => moveCursorToFirstLine(editor),
    });

    this.addCommand({
      id: 'moveCursorToLastLine',
      name: 'Move cursor to last line',
      hotkeys: [
        {
          modifiers: ['Mod', 'Shift'],
          key: 'End',
      ...
      editorCallback: (editor) => moveCursorToLastLine(editor),
    });
